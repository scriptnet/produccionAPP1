                        ...
                        <form action="{{route('vendor.business-settings.update-setup',[$restaurant['id']])}}" method="post"
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-12">
                                    ...
                                    <select name="off_day[]" class="form-control js-select2-custom" id="off_day" multiple="multiple" data-placeholder="Select off day" data-minimum-results-for-search="-1">
